...
function zapisz_wynik(){
	if(sprawdzPole("saper")){
		...
		localStorage.setItem("saper"+localStorage.getItem("saper_liczba"), JSON.stringify(wyniki));
		
		aktualna_liczba = localStorage.getItem("saper_liczba");
		localStorage.setItem( "saper_liczba",++aktualna_liczba );
		//reset mgły
