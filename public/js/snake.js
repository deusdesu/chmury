...
function porazka(){
	...
	docID("pokaz_mgle").innerHTML=`<div id="formularz"><form><input type="text" class = "koniec" placeholder="pseudonim" onfocus="this.placeholder=''" onblur="this.placeholder='pseudonim'" id="login">
    <div id="login_walidacja"></div>
    Twój wynik to: <b>`+liczba_punktów+`</b><input  type="button" id="wyslij" value="Zapisz swój wynik!"></form></div>`;
...
function zapisz_wynik(){
	if(sprawdzPole("snake")){
        ...
        zapiszWynikDoBazy(wyniki.login,'SNAKE',wyniki.lp)
		//reset mgły
